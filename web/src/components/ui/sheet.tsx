...
>(({ className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    <SheetPrimitive.Content
      ref={ref}
      className={cn(
        "fixed z-50 gap-4 bg-[#0f202d] p-6 text-slate-100 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=open]:slide-in-from-left data-[state=closed]:slide-out-to-left",
        "top-0 left-0 h-full w-80 border-r border-[#1e3442]",
        className,
      )}
      {...props}
    >
